...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-cog fa-spin"></i> Teacher List & Finance
            </li>
                ...
                <div class="col-sm-12 ">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading text-center">
                            <h2 class="panel-title fa-2x">Consultant & Financial status</h2>
                        </div>
                        <div class="row">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-right">
                                    <#--<button type="button" onClick="parent.location='/brtc/report/teachersFinance.buet?deptId=${DeptId}'" class="btn btn-xs btn-link">Download Report</button>-->
                                    <input type="button" class="btn-info" value="Download Report" onClick="parent.location='/brtc/report/teachersFinance.buet?deptId=${DeptId}'"/>
                                </div>
                            </div>
                        </div>

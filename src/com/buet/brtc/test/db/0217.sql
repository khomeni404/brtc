...
insert  into `abc_token`(`tokenId`,`password`,`username`,`userDetails_id`) values (1,'eDqReOp3KcE=','admin',1),(3,'hs7V9h485ik=','mak',2),(5,'s/rL2EnkrmE=','amin',3),(6,'Z4K3G7bpkus=','j.khan',4),(7,'vlvMchDKF+w=','f.alam',5);
...
insert  into `abc_user_auth`(`authorizeId`,`active`,`userType`,`token_tokenId`) values (1,'','System Engineer',1),(3,'','Teacher',3),(5,'','Teacher',5),(6,'','Teacher',6),(7,'','Teacher',7);
...
insert  into `abc_user_auth_abc_authorized_group`(`users_authorizeId`,`authorizedGroups_authorizedId`) values (1,1),(5,1),(3,1),(6,2);
...
insert  into `brtc_client`(`id`,`address`,`description`,`email`,`fax`,`name`,`phone`,`record_date`,`spokes_man`,`spokes_man_cell`,`operator_authorizeId`) values (2,'Address One','Desc 23','thisisemail@gmail.com','222222','BETS Consultancy services ltd.','111111','2015-02-13','Mr. Spokeman','3333333',1),(3,'TM Textiles & Garments Ltd','121212','123@123.22','222222','TM Textiles & Garments Ltd.','12121','2015-02-14','Mr. Spokeman3','3333333',NULL),(4,'Dhaka North City Corporation, Dhaka','444646','north@north.com','54545','Dhaka North City Corporation, Dhaka','9898989','2015-02-17','Mr. DCC North','0174454545454',NULL),(5,'Dhaka Northern Power Generations Ltd.','Dhaka Northern Power Generations Ltd.','ss@ss','554','Dhaka Northern Power Generations Ltd.','45454','2015-02-17','Mr. Spokes Man 45','0154545454',NULL),(6,'23, Motijhil, Dhaka','--','jhilmol@gmail.com','02-565985-565','Jhilmil Residential Project','02-55666-66','2015-02-17','Mr. Asmot Ali Khan','015454545454',NULL);
...
insert  into `brtc_consultant`(`id`,`activeDate`,`inactiveDate`,`note`,`recordDate`,`type`,`consultant_authorizeId`,`negotiateTeam_id`,`operator_authorizeId`,`active`) values (2,'2015-02-14','2015-02-14','---','2015-02-14',1,3,1,3,'\0'),(4,'2015-02-14',NULL,'---','2015-02-14',0,5,1,3,''),(5,'2015-02-17',NULL,'---','2015-02-17',0,6,2,1,'');
...
insert  into `brtc_dist_distribution`(`id`,`advances`,`brtcNos`,`consultantFees`,`distributionDate`,`others`,`recordDate`,`totalAmount`,`operator_authorizeId`,`project_id`) values (11,10000,'1100-77970/CE/2014-15, 1100-77973/CE/2014-15',85000,'2015-01-25',5000,'2015-02-15',100000,3,1),(12,15000,'1100-77970/CE/2014-15, 1100-77973/CE/2014-15',120000,'2015-02-15',65000,'2015-02-15',200000,3,1),(13,3000,'1100-77970/CE/2014-15, 1100-77973/CE/2014-15',45000,'2015-02-15',2000,'2015-02-15',50000,1,1);
...
insert  into `brtc_dist_jt_distribution_receiver`(`DISTRIBUTION_ID`,`RECEIVER_ID`) values (11,9),(11,10),(11,11),(12,12),(12,13),(12,14),(13,15),(13,16),(13,17),(13,18);
...
insert  into `brtc_dist_jt_project_distribution`(`PROJECT_ID`,`DISTRIBUTION_ID`) values (1,11),(1,12),(1,13);
...
insert  into `brtc_dist_jt_teacher_received`(`TEACHER_ID`,`RECEIVER_ID`) values (3,9),(3,12),(3,15),(5,10),(5,13),(5,16),(6,11),(6,14),(6,17),(7,18);
...
insert  into `brtc_dist_jt_team_member_receiver`(`TEAM_MEMBER_ID`,`RECEIVER_ID`) values (1,9),(1,12),(1,15),(2,10),(2,13),(2,16),(3,11),(3,14),(3,17),(4,18);
...
insert  into `brtc_jt_client_project`(`CLIENT_ID`,`PROJECT_ID`) values (2,1),(3,2),(4,3),(5,4),(6,5);
...
insert  into `brtc_jt_department_project`(`DEPARTMENT_ID`,`PROJECT_ID`) values (1,1),(1,2),(1,3),(1,4),(1,5);
...
insert  into `brtc_jt_negotiate_team_consultant`(`TEAM_ID`,`CONSULTANT_ID`) values (1,2),(1,4),(2,5);
...
insert  into `brtc_jt_project_client_payment`(`PROJECT_ID`,`PAYMENT_ID`) values (1,1),(1,2);
...
insert  into `brtc_jt_project_project_history`(`PROJECT_ID`,`HISTORY_ID`) values (1,1),(1,2),(3,8);
...
insert  into `brtc_jt_team_team_member`(`TEAM_ID`,`MEMBER_ID`) values (2,1),(2,2),(2,3),(2,4);
...
insert  into `brtc_jt_user_consultant`(`USER_ID`,`CONSULTANT_ID`) values (3,2),(5,4),(6,5);
...
insert  into `brtc_jt_user_team_member`(`USER_ID`,`MEMBER_ID`) values (3,1),(5,2),(6,3),(7,4);
...
insert  into `brtc_negotiate_team`(`id`,`assignDate`,`isActive`,`recordDate`,`operator_authorizeId`,`project_id`,`teamLeader_authorizeId`) values (1,'2015-02-14','','2015-02-14',3,1,5),(2,'2015-02-17','','2015-02-17',1,3,6);
...
insert  into `brtc_project_status`(`id`,`progress_status`,`financial_status`,`distribution_status`,`record_date`,`operator_authorizeId`) values (1,5,1,0,'2015-02-13',1),(2,0,0,0,'2015-02-14',3),(3,1,0,0,'2015-02-17',1),(4,0,0,0,'2015-02-17',1),(5,0,0,0,'2015-02-17',1);
...
insert  into `brtc_team`(`id`,`formedDate`,`isActive`,`isApprove`,`recordDate`,`teamType`,`operator_authorizeId`,`project_id`,`teamLeader_id`) values (2,'2015-02-14','\0','\0','2015-02-14',0,3,1,3);
...
insert  into `brtc_team_member`(`id`,`active`,`memberType`,`note`,`recordDate`,`operator_authorizeId`,`team_id`,`teamMember_authorizeId`,`activeDate`,`inactiveDate`) values (1,'\0',1,'---','2015-02-14',3,2,3,'2015-02-14','2015-02-14'),(2,'',1,'---','2015-02-14',3,2,5,'2015-02-14',NULL),(3,'',0,'---','2015-02-14',3,2,6,'2015-02-17',NULL),(4,'\0',1,'---','2015-02-15',1,2,7,NULL,NULL);
...
insert  into `hrm_department_hrm_user_details`(`HRM_DEPARTMENT_id`,`userDetailsList_id`) values (1,2),(1,3),(1,4),(1,5);
...
insert  into `hrm_designation_hrm_user_details`(`HRM_DESIGNATION_id`,`userDetailsList_id`) values (1,2),(1,3),(1,4),(1,5);

...
insert  into `brtc_consultant`(`id`,`activeDate`,`inactiveDate`,`note`,`recordDate`,`type`,`consultant_authorizeId`,`negotiateTeam_id`,`operator_authorizeId`,`active`) values (2,'2015-02-14','2015-02-14','---','2015-02-14',1,3,1,3,'\0'),(4,'2015-02-14',NULL,'---','2015-02-14',0,5,1,3,'');
...
insert  into `brtc_dist_distribution`(`id`,`advances`,`brtcNos`,`consultantFees`,`distributionDate`,`others`,`recordDate`,`totalAmount`,`operator_authorizeId`,`project_id`) values (11,10000,'1100-77970/CE/2014-15, 1100-77973/CE/2014-15',85000,'2015-01-25',5000,'2015-02-15',100000,3,1),(12,15000,'1100-77970/CE/2014-15, 1100-77973/CE/2014-15',120000,'2015-02-15',65000,'2015-02-15',200000,3,1);
...
insert  into `brtc_jt_client_project`(`CLIENT_ID`,`PROJECT_ID`) values (2,1),(3,2);
...
insert  into `brtc_jt_negotiate_team_consultant`(`TEAM_ID`,`CONSULTANT_ID`) values (1,2),(1,4);
...
insert  into `brtc_jt_project_project_history`(`PROJECT_ID`,`HISTORY_ID`) values (1,1),(1,2);
...
insert  into `brtc_jt_team_team_member`(`TEAM_ID`,`MEMBER_ID`) values (2,1),(2,2),(2,3);
...
insert  into `brtc_jt_user_consultant`(`USER_ID`,`CONSULTANT_ID`) values (3,2),(5,4);
...
insert  into `brtc_jt_user_team_member`(`USER_ID`,`MEMBER_ID`) values (3,1),(5,2),(6,3);
...
insert  into `brtc_negotiate_team`(`id`,`assignDate`,`isActive`,`recordDate`,`operator_authorizeId`,`project_id`,`teamLeader_authorizeId`) values (1,'2015-02-14','','2015-02-14',3,1,5);
...
insert  into `brtc_project_status`(`id`,`distribution_status`,`financial_status`,`progress_status`,`record_date`,`operator_authorizeId`) values (1,0,1,1,'2015-02-13',1),(2,0,0,0,'2015-02-14',3);
...
insert  into `brtc_team_member`(`id`,`active`,`memberType`,`note`,`recordDate`,`operator_authorizeId`,`team_id`,`teamMember_authorizeId`,`activeDate`,`inactiveDate`) values (1,'\0',1,'---','2015-02-14',3,2,3,'2015-02-14','2015-02-14'),(2,'',1,'---','2015-02-14',3,2,5,'2015-02-14',NULL),(3,'\0',0,'---','2015-02-14',3,2,6,NULL,NULL);
